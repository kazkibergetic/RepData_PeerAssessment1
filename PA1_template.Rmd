...
In total there `r totalNAs` missing values in the dataset.
...
The mean of the total number of steps taken per day is `r meanStepsFilled`

The median of the total number of steps taken per day is `r medianStepsFilled`
